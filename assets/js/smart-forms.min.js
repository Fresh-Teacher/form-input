! function i(s, a, u) {
    ...
    1: [function(e, t, n) {
        ...
        function v() {
            ...
            e.redirectURL && s(e.redirectURL) ? window.location.href = e.redirectURL : (i(f.element, "smart-form-sent"), y({
                status: "success",
                title: e.title,
                message: e.message
            }), f.reset())
        ...
        function b() {
            var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            i(f.element, "smart-form-error"), y({
                status: "error",
                title: e.title,
                message: e.message
            })
        ...
        a(p, {
            ...
            if (!f) return;
            10485760 < f.getFileSize() ? y({
                status: "error",
                title: f.getMessage("filesize", "title", f.getMessage("error", "title")),
            ...
            var t = e.data,
                n = t.operation,
                r = t.recaptchaToken;
            "submitEmail" === n ? (o = r, f.submit(u, "POST", [{
                name: "recaptchaToken",
                value: o
            }, {
                name: "sentFromURL",
            ...
            var o
        }), r(document, "submit", "form[data-bss-recipient]", function(e) {
            e.preventDefault(), f = new o(e.target, {
                onSuccess: v,
                onError: b,
            ...
            }), t = new URL(l), n = new URLSearchParams(t.search.slice(1)), r = f.getMessage("close"), n.append("closeBtnText", r), t.search = n.toString(), p.src = t.toString(), document.body.appendChild(p), document.body.appendChild(h);
            var t, n, r
        }, !0), r(h, "click", null, g)
    }, {
        "./src/Form": 6,
        ...
        var o = function() {
            ...
            return r(t, null, [{
                ...
                value: function(n) {
                    ...
                    for (var s in n.beforeSend && n.beforeSend(), i.open(r, o, !0), i.onload = function(e) {
                            if (4 === i.readyState) {
                                var t = {};
                                try {
